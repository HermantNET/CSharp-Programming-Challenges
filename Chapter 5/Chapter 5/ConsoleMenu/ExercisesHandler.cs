...
namespace ConsoleMenu
{
    class ExercisesHandler
    {
        public static void ExerciseHandler(string currentSelection)
        {
            ...
            {
                case "Exercise 1":
                        dynamic_ex = new Chapter_5.Exercises.Exercise_1.Exercise();
                        dynamic_ex.Run();
                    break;
                case "Exercise 2":
                        dynamic_ex = new Chapter_5.Exercises.Exercise_2.Exercise();
                        dynamic_ex.Run();
                    break;
                case "Exercise 3":
                        dynamic_ex = new Chapter_5.Exercises.Exercise_3.Exercise();
                        dynamic_ex.Run();
                    break;
                case "Exercise 4":
                    dynamic_ex = new Chapter_5.Exercises.Exercise_4.Exercise();
                    dynamic_ex.Run();
                    break;
                case "Exercise 6":
                    dynamic_ex = new Chapter_5.Exercises.Exercise_6.Exercise();
                    dynamic_ex.Run();
                    break;
                default:
                    Environment.Exit(0);
